...
public class WeatherProvider extends ContentProvider
{
    ...
    static UriMatcher buildUriMatcher()
    {
        ...
        // For Each type of URI we would add different codes.
    ...
    /*
        ...
        Here We Return the Appropriate MIME Types for the URI Types.
     */
    @Override
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // Notifying the ContentResolver and then closing the database
        db.close();
